...
export const metadata = { title: "Aufgaben-Eingang – Aufgabentool" };
...
export default async function OnofficeEingang() {
  ...
  return (
    <div>
      <Seitenkopf
        titel="Aufgaben-Eingang"
        text={`Die echten Aufgaben aus dem CRM, geändert seit ${formatDate(since)}. Diese Seite liest nur – sie ist zum Gegenprüfen da, nicht zum Arbeiten.`}
      />
